...
export const metadata = {
  title: "Return && Refund",
  description: "Return and Refund Policy for Our Website",
};
    ...
    <>
      ...
      <>
        ...
        <section className="s-title-page">
          <div className="container">
            <h4 className="s-title letter-0 text-center">Return && Refund</h4>
          </div>
        </section>
                ...
                <div className="content">
                  ...
                  <div className="term-item">
                    ...
                    <div className="text-wrap">
                      ...
                      <a href="mailto:eshop@stedfastz.com" className="link">
                        eshop@stedfastz.com
                      </a>
                    </div>
                  </div>
